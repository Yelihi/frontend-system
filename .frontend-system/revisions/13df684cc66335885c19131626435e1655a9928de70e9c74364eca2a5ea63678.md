...
## 2026-09-22 reliability hardening

User authorized the recommended repairs and repeated evaluation. This policy pins
three bounded FS tool guarantees: exact Git paths, durable stale verification and
protected test oracles with readable policy migration. Preserve the earlier design.
Run typecheck, lint and actual tests; review code AND tests. Package/frontend smoke
results are supporting evidence, not consumer-project verification.
