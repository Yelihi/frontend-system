...
- 원문·요청 URL: https://frontend-fundamentals.com/a11y/basic-guide/role.html
...
HTML의 암시적 역할과 커스텀 요소의 명시적 role을 설명한다.

## AI 검토와 반영 범위

네이티브 요소에 중복 role을 일괄 추가하지 않는다. 링크는 href 등 실제 속성과 문맥까지 봐야 하며 role만으로 키보드 동작은 생기지 않는다.
