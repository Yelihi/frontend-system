...
- 원문·요청 URL: https://frontend-fundamentals.com/a11y/principles.html
...
구조, 이름, 예상 가능한 동작, 시각 정보의 대안을 중심으로 접근성을 설명한다.

## AI 검토와 반영 범위

이 네 가지는 해당 가이드의 교육용 분류다. WCAG의 네 원칙과 동일한 목록으로 배포하지 않는다.
