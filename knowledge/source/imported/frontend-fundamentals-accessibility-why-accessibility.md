...
- 원문·요청 URL: https://frontend-fundamentals.com/a11y/why.html
...
네이티브 링크와 폼의 기본 동작, 의미 기반 테스트가 제공하는 실용적 이점을 설명한다.

## AI 검토와 반영 범위

역할과 이름으로 찾는 테스트가 사용자 관점에 가깝지만, 테스트 통과가 키보드·스크린리더 접근성 전체를 증명하지 않는다. test id를 항상 금지하는 정책은 도출하지 않는다.
