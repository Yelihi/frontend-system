...
- 원문·요청 URL: https://frontend-fundamentals.com/a11y/basic-guide/label.html
...
컨트롤의 label, 그룹의 legend, 이미지·아이콘의 이름을 설명한다.

## AI 검토와 반영 범위

이미지 픽셀 안의 글자만으로 대체 텍스트가 제공되지는 않는다. 주변 실제 텍스트가 같은 정보를 전달하는지 확인한다. 이미지 가격 정보를 언제나 alt에 넣는 규칙은 생략한다.
