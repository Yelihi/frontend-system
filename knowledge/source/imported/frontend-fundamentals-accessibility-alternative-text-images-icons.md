...
- 원문·요청 URL: https://frontend-fundamentals.com/a11y/alt-text/image-alt.html
...
정보 이미지·기능 아이콘·장식 이미지의 목적에 따라 텍스트 대안을 선택한다.

## AI 검토와 반영 범위

caption이나 이미지 내부 글자만 있다는 이유로 alt를 비우지 않는다. 같은 정보가 실제 텍스트로 제공되는지 보며, 복잡한 그래프는 짧은 alt 외에 상세 정보가 필요할 수 있다.

확인한 보완 근거:

- [공식 근거 1](https://www.w3.org/WAI/tutorials/images/decision-tree/)
