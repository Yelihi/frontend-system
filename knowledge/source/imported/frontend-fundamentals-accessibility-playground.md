...
- 원문·요청 URL: https://frontend-fundamentals.com/a11y/playground.html
...
스크린리더로 접근성 문제를 체험하는 콘텐츠와 기간이 있는 참여 행사를 안내한다.

## AI 검토와 반영 범위

본문만 읽었고 체험·음성·삽입 콘텐츠는 실행하지 않았다. 행사 최신성과 체험 결과는 미확인이다. 독립적인 구현 근거가 없어 learned 배포는 생략한다.
